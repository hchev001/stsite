...
const LESSEP_2016 = () => {
  const data = useStaticQuery(graphql`
    query {
      allMarkdownRemark(
        filter: { id: { eq: "4dfda91d-7f28-53a6-874f-b1421f1d7b87" } }
      ) {
        nodes {
          id
          frontmatter {
      ...
      smallImages: allFile(
        filter: { relativeDirectory: { eq: "events/lessep-2016/images/small" } }
      ...
      largeImages: allFile(
        filter: { relativeDirectory: { eq: "events/lessep-2016/images/large" } }
        sort: { order: ASC, fields: base }
      ) {
        edges {
          node {
