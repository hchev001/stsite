...
const WISTPC_2010 = () => {
  const data = useStaticQuery(graphql`
    query {
      ...
      smallImages: allFile(
        filter: { relativeDirectory: { eq: "events/wistpc-2010/images/small" } }
      ...
      largeImages: allFile(
        filter: { relativeDirectory: { eq: "events/wistpc-2010/images/large" } }
        sort: { order: ASC, fields: base }
      ) {
        edges {
          node {
      ...
      <Container>
        ...
        <Row>
          ...
          <CenteredCol sm={4}>
            ...
            <small>WISTPC-10 Participants</small>
          </CenteredCol>
        </Row>
        <hr />
        <Row>
